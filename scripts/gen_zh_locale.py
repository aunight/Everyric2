...
ZH: dict[str, str] = {
    ...
    "captions_autoGenerated": "自動生成",
    "captions_uploader": "上傳者字幕",
    "pip_controls_micDisplayToggle": "切換採點顯示：音高軌跡／命中音符",
    "overlay_settings_sourcePriority_netease": "優先網易雲音樂",
    "overlay_settings_row_micDisplayMode": "採點顯示方式",
    "overlay_settings_micDisplayMode_trace": "音高軌跡",
    "overlay_settings_micDisplayMode_notes": "命中音符（卡拉OK）",
    "overlay_pronChip_pinyin": "拼音",
