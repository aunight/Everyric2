...
export const ICONS = {
  // 채점(가라오케) 창 — PiP 사각형 아이콘은 무슨 버튼인지 못 알아본다는 실보고로 음표로 교체
  pip: '<svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 3v10.55A4 4 0 1 0 14 17V7h4V3h-6z"/></svg>',
